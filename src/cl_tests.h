...
void cl_tests_print_particle_positions_with_ghosts(int, cl_char *, int, int, int, int);
...
int cl_tests_particles_intersect(float,float,float,float,float,float,float,float);
int cl_tests_intersect(int,float *,float *,float *,float *, int);
#endif
